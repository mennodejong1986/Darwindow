...
The file 'myvcfsamples.txt', which lists the order of individuals in the vcf-file, is generated by one of preparatory steps of the VCF_darwindow.sh script.
