...
The file 'popfile.txt' is a tab-separated file with at minimum three columns, named 'name', 'pop' and 'popcol'.
The file 'myvcfsamples.txt', which lists the order of individuals in the vcf-file, is generated by one of the preparatory steps of the VCF_darwindow.sh script.
